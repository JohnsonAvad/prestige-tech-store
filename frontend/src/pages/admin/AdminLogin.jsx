            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 text-white placeholder-white/20 text-sm outline-none focus:border-blue-500 focus:bg-white/10 transition-all duration-200"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <div className="text-center space-y-3">
              ...
              <p className="text-white/30 text-xs leading-relaxed">
                This is a secured management portal. Unauthorised access is
                strictly prohibited. All login activity is monitored and logged.
              </p>
